# AGENTS.md — Guía para crear visuales HTML

Este archivo le indica a Codex cómo crear correctamente un nuevo visual HTML para el repo `apuntes-visuales`, desplegado en Vercel.
